	...
	for	layer_index in range(0, num_layers-1):
		...
		for epoch_index in range(num_epoches):
			...
			for i in range(output_dimension):
				...
				weight_scales_left[i] = left_curr_val * (left_curr_val - right_curr_val) * (1.0 - left_curr_val)
				weight_scales_right[i] = right_curr_val * (left_curr_val - right_curr_val) * (1.0 - right_curr_val)
